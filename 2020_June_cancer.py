...
for cancer0, cancer1 in pairs(cancers):
    ...
    plt.tight_layout()
    plt.savefig('ROC_Curve_{}_{}_5.png'.format(cancer0.cancerType,cancer1.cancerType))
    plt.close()
...
accOrder = []
ssOrder = []
pairwise_plot(accOrder, newCancers, cancerAccuracies, accuracy_std, "Binary Classifier Accuracies", "accuracies_new_mac")
pairwise_plot(ssOrder, newCancers, cancerSense, sense_std, "Binary Classifier Sensitivity/Specificity", "sense_spec_new_mac")
