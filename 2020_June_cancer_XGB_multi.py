...
for i in range(len(cancers)):
    ...
    plt.tight_layout()
    plt.savefig('{}_multiclass.png'.format(cancernames[i]),bbox_inches = 'tight',dpi = 300)
    plt.savefig('{}_multiclass.pdf'.format(cancernames[i]),bbox_inches = 'tight',dpi = 300)
    plt.savefig('{}_multiclass.svg'.format(cancernames[i]),bbox_inches = 'tight',dpi = 300)
    plt.close()   
g.close()  
f.close()
