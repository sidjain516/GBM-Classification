...
if __name__ == "__main__":
    ...
    path = "/home/sjain2/PPA/PPAA/"
    file1 = "Bug1-Pat1.txt"
    file2 = "Bug1-Pat2.txt"
    numCores = 4
    gapScore = 0.4
    maxDel = 300  # An upper bound on the number of expected deletions. Set to -1 if not wanted.
    ...
    for seq in sequences:
        ...
        for line in f:
            ...
            seq[1].append(ppyClasses.DataPoint(lineSplit[18], int(lineSplit[16]), int(lineSplit[17])))
        f.close()
    ...
    for i in range(m1P + m2P - 1):
        ...
        print "Finished diagonal", i, "on", avSlots
