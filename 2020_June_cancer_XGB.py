...
def pairwise_plot(oldCancers, newCancers, distanceFunction, distanceSTD, title, file):
    ...
    plt.savefig("{}.pdf".format(file),dpi = 300)
    plt.savefig("{}.svg".format(file),dpi = 300)
    plt.close()
...
for cancer0,cancer1 in pairs(cancers):
    ...
    plt.tight_layout()
    plt.savefig('ROC_Curve_{}_{}_XGB_5.png'.format(cancer0.cancerType,cancer1.cancerType),dpi = 300)
    plt.savefig('ROC_Curve_{}_{}_XGB_5.pdf'.format(cancer0.cancerType,cancer1.cancerType),dpi = 300)
    plt.savefig('ROC_Curve_{}_{}_XGB_5.svg'.format(cancer0.cancerType,cancer1.cancerType),dpi = 300)
    plt.close()
